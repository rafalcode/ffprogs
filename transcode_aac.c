 ...
 *
 * rf notes: will take an mp3 file and out to mp4 container, only holding an aac.
 * best therefore to output to aac.
 * however simple aac also carries warning, "duration estimated from bitrate"
 */
